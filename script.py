...
st.markdown(
    ...
    <div style="text-align: center; margin-bottom: 20px; margin-top: -86px;">
        <div style="display: flex; justify-content: center; margin-bottom: 16px; margin-top: 5px;">
        ...
        <h2 style="margin: -30px -30px 0 0; color: #f3f3f7; font-size: 1.8em; font-weight: 600;">LSAS AI Help Agent</h2>
    </div>
    """,
    unsafe_allow_html=True
)
